...
// Root layout — used to host the lazy <Outlet/> under a single Suspense
// boundary. Providers live above the <RouterProvider> in the JSX below so
// useAuth/useTenant work in every route component.
function RootLayout() {
  return (
